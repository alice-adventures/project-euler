...
package Project_Euler.CLI.Problem is
   ...
   function Title (Problem : CLI_Problem_Type) return String is abstract;
   --  Return the problem name exactly as named by Project Euler.

   function Brief (Problem : CLI_Problem_Type) return String is abstract;
   ...
   function Answer
     (Problem : in out CLI_Problem_Type; Notes : in out Unbounded_String)
