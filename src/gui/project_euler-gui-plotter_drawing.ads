...
package Project_Euler.GUI.Plotter_Drawing is
   ...
   type Plotter_Drawing_IFace is limited interface;
   ...
   procedure Set_Axes
     (Plotter                    : in out Plotter_Drawing_IFace;
   ...
   procedure Plot
     (Plotter : in out Plotter_Drawing_IFace; Points : Point_List;
      Color   :        String) is abstract;
   --  Plot the given map represented as a point list.

   procedure Line_Width
     (Plotter : in out Plotter_Drawing_IFace; Width : Natural) is abstract;

   procedure Line_Dash
     (Plotter : in out Plotter_Drawing_IFace; Length : Natural;
      Gap     :        Natural) is abstract;

   procedure Stroke_color
     (Plotter : in out Plotter_Drawing_IFace; Color : String) is abstract;
   ...
   procedure Font
     (Plotter : in out Plotter_Drawing_IFace; Font : String;
      Height  :        String) is abstract;

   procedure Text_Align
     (Plotter : in out Plotter_Drawing_IFace; Align : String) is abstract;

   procedure Text_Baseline
     (Plotter : in out Plotter_Drawing_IFace; Baseline : String) is abstract;

   procedure Text
     (Plotter : in out Plotter_Drawing_IFace; X, Y : Float;
      Text    :        String) is abstract;

   procedure Answer
     (Plotter : in out Plotter_Drawing_IFace; Answer : String) is abstract;
